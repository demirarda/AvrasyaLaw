...
namespace ErtugrulYildiz.Controllers
{
    public class AdminContactController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IletisimId,Mail,Telefon,Adres")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IletisimId,Mail,Telefon,Adres")] Contact contact)
        {
            if (ModelState.IsValid)
            {
